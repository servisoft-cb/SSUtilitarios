...
begin
  ...
  vExisteAux := fnc_Abrir_Produto_Forn(fDMRecebeXML,vCodFornecedor,fDMRecebeXML.mItensNotaCodProduto.AsString,fDMRecebeXML.mItensNotaCodBarra.AsString,fDMRecebeXML.mItensNotaCodBarra2.AsString);
  if vExisteAux then
  begin
...
begin
  ...
  begin
    if not fnc_Abrir_Produto_Forn(fDMRecebeXML,vCodFornecedor,fDMRecebeXML.mItensNotaCodProduto.AsString,fDMRecebeXML.mItensNotaCodBarra.AsString,fDMRecebeXML.mItensNotaCodBarra2.AsString) then
  ...
  try
   ...
   // fDMRecebeXML.cdsNotaFiscal.ApplyUpdates(0);
    ...
    begin
      ...
      begin
        Gravar_Duplicata(fDMRecebeXML,'P','N','',fDMRecebeXML.cdsNotaFiscal_ParcITEM.AsInteger,fDMRecebeXML.cdsNotaFiscal_ParcVLR_VENCIMENTO.AsFloat,
                         fDMRecebeXML.cdsNotaFiscal_ParcDTVENCIMENTO.AsDateTime,0,0);
