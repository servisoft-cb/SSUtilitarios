...
type
  TfrmGeraCBenefSC = class(TForm)
    ...
    sdsCBenefTRIBUTO: TStringField;
    sdsCBenefAPLICA_SIMPLES: TStringField;
    sdsCBenefCST_02: TStringField;
    sdsCBenefCST_15: TStringField;
    sdsCBenefCST_53: TStringField;
    sdsCBenefCST_61: TStringField;
    sdsCBenefBENEFICIO: TStringField;
    cdsCBenefTRIBUTO: TStringField;
    cdsCBenefAPLICA_SIMPLES: TStringField;
    cdsCBenefCST_02: TStringField;
    cdsCBenefCST_15: TStringField;
...
var
  frmGeraCBenefSC: TfrmGeraCBenefSC;
...
function TfrmGeraCBenefSC.fnc_verifica_Arquivo(NomeArquivo,
...
procedure TfrmGeraCBenefSC.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := Cafree;
end;

function TfrmGeraCBenefSC.Monta_Numero(Campo: String;
      ...
      try
        ...
        begin
          ...
          begin
            ...
            cdsCBenefCODIGO.AsString := gGrid.Cells[20,Linha];
            cdsCBenefUF.AsString     := 'SC';
          end;
          cdsCBenefDESCRICAO.AsString := gGrid.Cells[19,Linha];
          cdsCBenefOBS.AsString       := gGrid.Cells[2,Linha];
          vTexto1 := Monta_Numero(gGrid.Cells[21,Linha],0);
          ...
          vTexto1 := Monta_Numero(gGrid.Cells[22,Linha],0);
          if trim(vTexto1) <> '' then
          begin
            vTexto1 := Monta_Numero(vTexto1,8);
            vTexto1 := copy(vTexto1,1,2) + '/' + copy(vTexto1,3,2) + '/' + copy(vTexto1,5,4);
...
function TfrmGeraCBenefSC.XlsToStringGrid2(AGrid: TStringGrid; AXLSFile: string;
